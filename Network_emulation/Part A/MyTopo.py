...
def run():
    ...
    net.get("h1").cmd("ip route add default via 192.0.1.2 dev h1-eth1")
    net.get("h2").cmd("ip route add default via 197.0.1.2 dev h2-eth1")
    
    net.get("r1").cmd("ip route add 196.0.1.0/24 via 194.0.1.2 dev r1-eth3")
    net.get("r1").cmd("ip route add default via 193.0.1.2 dev r1-eth2")
    
    net.get("r2").cmd("ip route add 192.0.1.0/24 via 193.0.1.1 dev r2-eth1")
    net.get("r2").cmd("ip route add 194.0.1.0/24 via 193.0.1.1 dev r2-eth1")
    net.get("r2").cmd("ip route add default via 195.0.1.2 dev r2-eth2")
    
    net.get("r3").cmd("ip route add 192.0.1.0/24 via 194.0.1.1 dev r3-eth1")
    net.get("r3").cmd("ip route add 193.0.1.0/24 via 194.0.1.1 dev r3-eth1")
    net.get("r3").cmd("ip route add default via 196.0.1.2 dev r3-eth2")
    
    net.get("r4").cmd("ip route add 194.0.1.0/24 via 196.0.1.1 dev r4-eth2")
    net.get("r4").cmd("ip route add default via 195.0.1.1 dev r4-eth1")
